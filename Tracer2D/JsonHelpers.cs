...
public static class JsonHelpers
{
    ...
    {
        return el.GetProperty<JsonElement>(name, JsonValueKind.Object, (element, out i) => { i = element; return true; });
    }

    public static JsonElement GetArray(this JsonElement el, string name)
    {
        return el.GetProperty<JsonElement>(name, JsonValueKind.Array, (element, out i) => { i = element; return true; });
    }
